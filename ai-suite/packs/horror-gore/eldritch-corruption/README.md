# Eldritch Corruption Effects

Generate eldritch corruption effects effects with customizable horror levels.

## Description

This workflow generates eldritch corruption effects effects with customizable levels of horror and gore elements.
...
```
POST /api/v1/generate/horror-eldritch-corruption
```
...
```bash
curl -X POST http://localhost:8080/api/v1/generate/horror-eldritch-corruption \
  -H "Content-Type: application/json" \
  -d '{
    "image": "https://example.com/input.jpg",
    "prompt": "eldritch-corruption effects, horror atmosphere",
...
- Format: WEBP
- Contains: eldritch corruption effects effects
