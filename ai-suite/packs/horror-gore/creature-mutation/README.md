# Creature Mutation Generator

Generate creature mutation generator effects with customizable horror levels.

## Description

This workflow generates creature mutation generator effects with customizable levels of horror and gore elements.
...
```
POST /api/v1/generate/horror-creature-mutation
```
...
```bash
curl -X POST http://localhost:8080/api/v1/generate/horror-creature-mutation \
  -H "Content-Type: application/json" \
  -d '{
    "image": "https://example.com/input.jpg",
    "prompt": "creature-mutation effects, horror atmosphere",
...
- Format: WEBP
- Contains: creature mutation generator effects
