...
Generate blood overlay effects effects with customizable horror levels.

## Description

This workflow generates blood overlay effects effects with customizable levels of horror and gore elements.
...
```
POST /api/v1/generate/horror-blood-overlay
```
...
```bash
curl -X POST http://localhost:8080/api/v1/generate/horror-blood-overlay \
  -H "Content-Type: application/json" \
  -d '{
    "image": "https://example.com/input.jpg",
    "prompt": "blood-overlay effects, horror atmosphere",
...
- Format: WEBP
- Contains: blood overlay effects effects
