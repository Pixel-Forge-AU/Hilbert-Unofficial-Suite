...
for the AI Suite V2 repository. It creates README.md files, workflow catalogs,
...
def generate_catalog_readme(
    ...
    lines.append("# AI Suite V2 Workflow Catalog")
    lines.append("")
    ...
    lines.append("---")
    lines.append("")
    lines.append("*Generated by AI Suite V2 Documentation Generator*")
